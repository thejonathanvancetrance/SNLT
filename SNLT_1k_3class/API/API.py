...
def getBestModel(N, xDf, yDf, emptyModel, paramGrid, features, metricToOptimize='r2'):
    ...
    ## return the results
    return avgMAE, avgRSq, bestMAE, bestRSq, bestModel, featuresUsed, accuracy, f1, mcc
...
def saveMLResults(xTest, yTest, N, xDf, yDf, modelList, workingDir, numFeatures, printResults=True):
    ...
    for tup in modelList:
        ...
        # get results
        avgMAE, avgRSq, bestMAE, bestRSq, bestModel, bestFeatures, accuracy, f1, mcc = getBestModel(N, xDf, yDf, model, paramGrid, 
        ...
        fig=plot_confusion_matrix(bestModel, xTest, yTest, display_labels=["Low Yield","Medium Yield","High Yield"])
